基于参考程序中的输出格式，我来添加这些函数。以下是完整的改进代码：
...
### 2. **`info_step(msg: &str, length: usize, fillchar: char)` 函数**
- 显示居中的步骤标题
- 自动计算填充字符数量
- 支持不同长度和填充字符

### 3. **`info_status(msg_body: &str, status: u8)` 函数**
- 显示带状态图标的状态消息
- 状态代码：
  - `0` - ✅ 成功
  - `1` - ❌ 错误
...
ℹ️ 2024-01-15 10:30:45 - Base text: john,john@example.com,example.com
ℹ️ 2024-01-15 10:30:45 - Raw SHA256 hash: a1b2c3d4e5f6...
ℹ️ 2024-01-15 10:30:45 - Truncated to 10 chars: a1b2c3d4e5
ℹ️ 2024-01-15 10:30:45 - Added end character '!'
ℹ️ 2024-01-15 10:30:45 - First 3 characters uppercased
✅ 2024-01-15 10:30:45 - Final result: john,A1B2c3d4e!,example.com
```

这样的输出格式更加专业和用户友好，提供了清晰的进度指示和详细的状态信息。